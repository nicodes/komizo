...
//
// PAST TENSE NOW. That paragraph said "it is STILL true, because the unsigned
// GETs are still served" -- correct when this file was the half of a migration
// that only ADDED the signed form. komizo-be#72 removed the other half, so this
// is the gate rather than a second door beside an open one, and the sentence
// that described the hole would now describe a route that does not exist.
//
